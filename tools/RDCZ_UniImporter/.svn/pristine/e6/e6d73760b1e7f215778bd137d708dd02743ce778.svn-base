            ...
            switch (oneSource.source) {
                case DIRECTORY:
                    try {
                        ...
                        LOG.log(Level.SEVERE, "DEMON DATASOURCE (directory) START FAILED", ex);
                    }
                    break;
                case FTP:
                    try {
                        ...
                        LOG.log(Level.SEVERE, "DEMON DATASOURCE (ftp) START FAILED", ex);
                    }
                    break;
                case OAIPMH:
                    try {
                        ...
                        LOG.log(Level.SEVERE, "DEMON DATASOURCE (oaipmh) START FAILED", ex);
                    }
                    break;
                case ZAHORIKWAY:
                    try {
                        ...
                        LOG.log(Level.SEVERE, "DEMON DATASOURCE (zahorikway) START FAILED", ex);
                    }
                    break;
            }
        }
